...
button_0 = Button(window, text="0", width=button_width, height=button_height, font=button_font, command=lambda: button_click(0))
...
button_equal = Button(window, text="=", width=button_width,background="orange", height=button_height,font=button_font, command=button_equal)
button_clear = Button(window, text="C", width=button_width, height=button_height, font=button_font, command=button_clear)
button_posneg = Button(window,text="+/-", width=button_width, height=button_height, font=button_font, command=lambda: button_click('-'))
...
button_del=Button(window,text="Del", width=button_width, height=button_height, font=button_font, command=delete)
...
button_posneg.grid(row=5, column=1)
